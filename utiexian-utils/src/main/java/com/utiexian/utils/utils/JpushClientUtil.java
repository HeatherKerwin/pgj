...
/**
 * 极光推送工具类（根据设备RegistrationId）之前的根据别名暂时弃用
 * @author WKX
 */
public class JpushClientUtil {
	...
	public static class PushJob implements Runnable {
		public String registrationId;//推送的用户
		public SysteminfoType type;//消息类型
		public String des;//消息内容
		public PushJob(String registrationId,SysteminfoType type,String des) {
	        this.registrationId = registrationId;
	        this.type = type;
	        this.des = des;
	    }
		public void run() {
			JpushClientUtil.sendToRegistrationId(registrationId,"【票据管家】"+des,des,des,type.getValue());
		}
	}
...
//        if(JpushClientUtil.sendToRegistrationId("160a3797c83ea546c79","test","test","this is a Dev test","")==1){
