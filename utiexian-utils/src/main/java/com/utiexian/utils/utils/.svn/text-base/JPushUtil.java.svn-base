...
import com.utiexian.utils.enums.SysteminfoType;
...
public class JPushUtil {
	...
	public static class PushJob implements Runnable {
		...
		public SysteminfoType type;//消息类型
		public String des;//消息内容
		public PushJob(String moblie,SysteminfoType type,String des) {
	        this.moblie = moblie;
	        this.type = type;
	        this.des = des;
	    }
	 ...
	 * @param des 内容
	 */
	public static void doPushJob(String moblie,SysteminfoType type,String des){
	 ...
	 */
	public static PushResult pushToAlias(String alias,String alert,SysteminfoType type) throws APIConnectionException, APIRequestException{
		try {
	 ...
	 * @throws APIRequestException
	 */
	public static PushResult pushAllUser(String alert,SysteminfoType type) throws APIConnectionException, APIRequestException{
		JPushClient jpushClient = new JPushClient(masterSecret, appKey);
	...
	public static void main(String[] args) {
	    try {
	    	PushResult result = pushToAlias("13818994981","优惠消息",SysteminfoType.PREFERENTIALINFO);
