...
public class JGHisPriceZouShiInterceptor implements HandlerInterceptor {
	@Resource
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		String member_id = request.getParameter("memberid");//     ?待确定
		String belong = request.getParameter("belong");//?
		Actionlog actionlog = new Actionlog();
		if (StringUtils.isNoneBlank(member_id) && StringUtils.isNoneBlank(belong)&&!"undefined".equals(member_id)) {
			actionlog.setCode(Constant.HISPRICEZOUSHI_ORG);//机构
