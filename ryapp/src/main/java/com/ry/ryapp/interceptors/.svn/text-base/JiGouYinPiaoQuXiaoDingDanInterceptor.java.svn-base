...
public class JiGouYinPiaoQuXiaoDingDanInterceptor implements HandlerInterceptor {
	@Resource
	...
	public void afterCompletion(HttpServletRequest request,
			...
			if(StringUtils.isNoneBlank(member_id)&&!"undefined".equals(member_id)){
				if(jujue!=null && jujue.trim()!=""){
					actionlog.setCode(Constant.YINPIAOJUJUEDINGDAN_ORG); //机构 拒绝订单
				}else{
					actionlog.setCode(Constant.YINPIAOQUXIAODINGDAN_ORG); //机构 取消订单
				}
