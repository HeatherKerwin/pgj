...
@Controller
public class JiaoserenzhengInterceptor implements HandlerInterceptor{
	@Resource
	...
	public void afterCompletion(HttpServletRequest request,
		...
		String ipadr = HttpUtil.getIpAddr(request);
			...
			if (StringUtils.isNotBlank(memberId)&&!"undefined".equals(memberId)) {
				actionlog.setMemberId(Integer.valueOf(memberId));
				if("0".equals(type)){
					actionlog.setCode(Constant.JIAOSERENZHENG);
				}else{
					actionlog.setCode(Constant.JIAOSERENZHENG_ORG);
				}
