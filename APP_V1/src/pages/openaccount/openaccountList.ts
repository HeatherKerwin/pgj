...
@Component({
  selector: 'page-openaccountList',
  templateUrl: 'openaccountList.html'
})
export class OpenaccountListPage {
  public memberId = '';
  public orgType:any;
  public meType:any;
  ...
  openaccounTactive(){
    ...
    this.apiSev.api("newpost", "orginfo/rz", (res) => {
      ...
      if (data.response == 'success') {
        if( data.data.cib!=null && data.data.cib!=''){
          this.cib = data.data.cib;
          this.cib.id = data.data.cib.id;
          if(data.data.cib.imgPathA1!=null&& data.data.cib.imgPathA1!=''){
            this.openaccount.positive = this.apiSev.getOrderImgUrl+data.data.cib.imgPathA1;
            this.openaccount.positives = data.data.cib.imgPathA1;
            this.uploadFlag = true;
            this.isUploadD = false;
            this.isPicpathD = true;
          }
          if(data.data.cib.imgPathA2!=null&& data.data.cib.imgPathA2!=''){
            this.openaccount.sideitive = this.apiSev.getOrderImgUrl+data.data.cib.imgPathA2;
            this.openaccount.sideitives = data.data.cib.imgPathA2;
            this.uploadFlag = true;
            this.isUploadE = false;
            this.isPicpathE = true;
          }
          if(data.data.cib.imgPath20!=null&& data.data.cib.imgPath20!=''){
            this.openaccount.businesss = this.apiSev.getOrderImgUrl+data.data.cib.imgPath20;
            this.openaccount.businessss = data.data.cib.imgPath20;
            this.uploadFlag = true;
            this.isUpload = false;
            this.isPicpath = true;
          }
          if(data.data.cib.imgPath40!=null&& data.data.cib.imgPath40!=''){
            this.openaccount.attorney = this.apiSev.getOrderImgUrl+data.data.cib.imgPath40;
            this.openaccount.attorneys = data.data.cib.imgPath40;
            this.uploadFlag = true;
            this.isUploadB = false;
            this.isPicpathB = true;
          }
          if(data.data.cib.imgPathCnh!=null&& data.data.cib.imgPathCnh!=''){
            this.openaccount.offer = this.apiSev.getOrderImgUrl+data.data.cib.imgPathCnh;
            this.openaccount.offers = data.data.cib.imgPathCnh;
            this.uploadFlag = true;
