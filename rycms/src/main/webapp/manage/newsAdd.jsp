...
<body>
<form method="post" action="<%=path %>/news/add/" onsubmit="return checkForm()" id="form1">
<div id="top">
	<div class="left">
		...
		<div class="edit-box">
			...
			<div class="">
				<select name="type">
					...
					<option value="2">银行动态</option>
					<option value="3">市场分析</option>
					<option value="4">相关新闻</option>
				</select>
			</div>
		</div>
		<div class="edit-box">
