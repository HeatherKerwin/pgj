...
<body>
<form method="post" action="<%=path %>/admin/salepriceServlet.do?method=update" onsubmit="return checkForm()" id="form1">
<div id="top">
	<div class="left">
...
<div id="edit">
	...
	<div id="edit-main">
		<div class="edit-box">
			...
			<div class="">
				<input type="hidden" value="${saleprice.id }" name="id"/>
				<input name="begintime" id="begintime" type="text" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" readonly style="width:175px;cursor:pointer" value="${saleprice.begintimeStr}"/>
			</div>
		</div>
		<div class="edit-box">
			<div class="label"><label>结束时间</label></div>
			<div class="">
				<input name="endtime" id="endtime" type="text" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" readonly style="width:175px;cursor:pointer" value="${saleprice.endtimeStr}"/>
			</div>
		</div>
		<div class="edit-box">
			<div class="label"><label>价格</label></div>
			<div class="">
				<input type="text" name="price" value="${saleprice.price }"/>
			</div>
		</div>
		<div class="edit-box">
			<div class="label"><label>总限额</label></div>
			<div class="">
				<input type="text" name="alllimit" value="${saleprice.alllimit }"/>
			</div>
		</div>
		<br/>
	</div>
