...
<body>
<form method="post" action="<%=path %>/admin/historypriceServlet.do?method=add" onsubmit="return checkForm()" id="form1">
<div id="top">
	<div class="left">
...
<div id="edit">
	...
	<div id="edit-main">
		...
		<div class="edit-box">
			<div class="label"><label>地域</label></div>
			<div class="">
				<select name="type4">
		...
		<div class="edit-box">
			<div class="label"><label>涨跌</label></div>
			<div class="">
				<input type="text" name="updown"/>
			</div>
		</div>
		<div class="edit-box">
