...
<script>
	...
	function search(){
		location.href="../../admin/daypricesearch/?day="+$("#day").val()+"&type4="+$("#type4").val()+"&time="+$("#time").val();
	}
</script>
</head>
<body>

<form method="post" action="../../admin/updateprice/" onsubmit="return checkForm()" id="form1">
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" background="../../images/sctg/content_bg.gif"><table width="100%" height="58" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td height="31"><div class="title">价格走势 </div></td>
        </tr>
      </table></td>
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="1380px;" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr style="border:#CCC 1px solid; margin:6px 10px;">
          <td colspan="12"><!--<table class="title-1">
              <tr>
                <td ><h1 style="letter-spacing:3px;">价格走势 </h1></td>
              </tr>
            </table>-->
            ...
            <table class="title-2">
              <tr>
                <td  >&nbsp;</td>
                <td width="10%"  style="text-align:right;">日期</td>
                 <#if day??>
                	<td width="20%"><input type="text" id="day" name="day" value="${day}" onclick="SelectDate(this,'yyyy-MM-dd')" onchange="search()" readonly /></td>
                <#else>
                	<td width="20%"><input type="text" id="day"  name="day" value="日期" onclick="SelectDate(this,'yyyy-MM-dd')" onchange="search()" readonly /></td>
                </#if>
                <td  width="20">&nbsp;</td>
                
                <td width="10%" style="text-align:right;">时间</td>
                	<td width="20%">
                			<select name="time" id="time" onchange="search()">
								 <option value="10:30" <#if time=='10:30'>selected="selected"</#if>>10:30</option>
								 <option value="14:30" <#if time=='14:30'>selected="selected"</#if>>14:30</option>
								 <option value="16:30" <#if time=='16:30'>selected="selected"</#if>>16:30</option>
	    					</select>
                	</td>
                <td >&nbsp;</td>
