  ...
  <tr>
    ...
    <td valign="top" background="../../images/sctg/content_bg.gif">
    	<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" >
	        <tr>
	          <td height="31"><div class="title">人员列表</div></td>
	        </tr>
    	</table>
    </td>
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr style="text-align:left;">
        	<td>
        		<input class="btn" style="width:100px;line-height:30px;margin-top:5px;" type="button" value=" 新增客服" onclick="badd();"/>
        	</td>
        </tr> 
          ...
          <td width="96%"><table class="title-6" style="margin-left:8%;" width="80%"  >
              <tr>
                <td colspan="2"><form action="" method="">
                 ...
                 <#if adminList??>
					<#list adminList as member>                     
                      <tr align="center" class="d">
                        <td class="dd"><a href="../../admin/bupdate/?id=${member.id}"><font color="blue">${member.username }</font></a></td>
                        <td class="dd"><a href="javascript:void(0)" onclick="deleteuser(${member.id})"><font color="blue"> 删除 </font></a></td>                                                
                      </tr>
					</#list>
			     </#if>    
