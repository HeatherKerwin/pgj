...
.pagination a:hover, .pagination a:active {border: 1px solid green;color: #000;text-decoration: none;}
.pagination span.current {padding: 2px 5px;margin: 2px;border: 1px solid green;font-weight: bold;background-color: green;color: #FFF;}
.pagination span.disabled {padding: 2px 5px;margin: 2px;border: 1px solid #eee; color: red;}
</style>
<#-- 页号越界处理 -->
  <#if (pageNo > pageCount)>
