...
<script language="javascript">
	...
	function addInformation(){
		window.location.href="../../news/addInformation/";
	}
	function updateInformation(newsid){
		window.location.href="../../news/toupdate/?id="+newsid;
	}
</script>
<body>
  ...
  <tr>
    ...
    <td valign="top" background="${rc.contextPath}/images/sctg/content_bg.gif">
    	<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" >
	        <tr>
	          <td height="31"><div class="title">资讯列表</div></td>
	        </tr>
    	</table>
    </td>
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr style="text-align:left;">
        	<td>
        		<input class="btn" style="width:100px;line-height:30px;margin-top:5px;" type="button" value="新增市场信息" onclick="addInformation();"/>
        	</td>
        </tr> 
                ...
                <td colspan="2"><form action="" method="">
                    <table  class="cont tr_color" style="width:96%;table-layout:fixed;">
                      <tr>                      
                        ...
                        <th style="width:150px;">地址来源</th>
                        <th style="width:110px;">文章来源</th>
	                 ...
	                 <#if pr??  && pr.results??>
						<#list pr.results as news>                     
	                      <tr align="center" class="d">
	                        <td class="dd" align="left" title="${news.title }"><a href="../../news/toupdate/?id=${news.id}"><font color="blue">${news.title }</font></a></td>
	                        ...
	                        <td class="dd">
	                        		<#if news.updateTime??>
										${news.updateTime?string("yyyy-MM-dd HH:mm:ss")}
									</#if>	
	                        </td>
	                        <td class="dd">
