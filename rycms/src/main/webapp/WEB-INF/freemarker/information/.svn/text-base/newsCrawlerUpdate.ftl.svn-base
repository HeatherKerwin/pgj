...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="1380px;" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td colspan="4">
        	<form method="post" action="../../newscrawler/update/" onsubmit="return checkForm()" id="form1">
        	<table width="100%">
        		<tr>&nbsp;</tr>
        		 <tr >
        		 	<div id="edit">
						<div id="edit-main">
							...
							<div class="edit-box">
								...
								<div class="">
									<input name="createTime" id="day" type="text" onclick="SelectDate(this,'yyyy-MM-dd hh:mm')" readonly style="width:206px;cursor:pointer" value="${news.createTime?string("yyyy-MM-dd HH:mm")}"/>      
								</div>
							</div>
							<div class="edit-box">
							...
							<div class="edit-box">
								...
								<div class="">
									<input type="text" name="articleSource" value="${news.articleSource}"/>
