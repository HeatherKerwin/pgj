...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="1380px;" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td colspan="4">
        	<form method="post" action="../../piaojujiangtang/add/" onsubmit="return checkForm()" id="form1">
        	<table width="100%">
        		<tr>&nbsp;</tr>
        		 <tr >
        		 	<div id="edit">
        		 ...
        		 <tr>
        		 	 <tr style="text-align:left; margin-top:6px;">
		              	<td  colspan="2"><input class="btn" style=" width:100px; line-height:30px;" type="button" value="添加" onclick="chooseSubmitMethod()" /></td>
		        	 </tr> 
        		 </tr>
        	</table>
        	</form>
