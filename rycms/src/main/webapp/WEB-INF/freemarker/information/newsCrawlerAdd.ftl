		...
		onComplete: function(file, response){
			if (response == "") {
                ...
                if(response=='error'){
					...
					$("#singlepicdiv1").html("<img src='"+response+"' width='100px' height='100px'/><input type='hidden' value='"+response+"' name='pic'><font style='color:red;'>(640*400)</font>");
					button1.html('重新选择');
					window.clearInterval(interval1);
					// enable upload button1
					this.enable();
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="1380px;" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <tr style="text-align:left; margin-top:6px;">
        ...
        <tr>
        	<td colspan="4">
        	<form method="post" action = "../../news/add/" onsubmit="return checkForm()" id="form1" name="form1">
        	<table width="100%">
        		<tr>&nbsp;</tr>
        		 <tr >
        		 	<div id="edit">
						<div id="edit-main">
							<div class="edit-box">
								...
								<div class="">
									<select name="type" id="type">
										...
										<option value="1">票据新闻</option>
										<option value="2">金融动态</option>
										<option value="3">管家动态</option>
							...
							<div class="edit-box">
								...
								<div class="">
									<input name="publishtime" id="day" type="text" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" readonly style="width:206px;cursor:pointer" value="${publishtimeStr }"/>
								</div>
							</div>
							<div class="edit-box">
							...
							<div class="edit-box">
								...
								<div class="">
									<input type="text" name="articleSource"/>
								</div>
							</div>
							<div class="edit-box">
								<div class="label"><label>摘要</label></div>
								<div class="">
									<textarea name="abstracts" id="abstracts" cols="10" rows="25" style="width:423px;height:70px"></textarea>
								</div>
							</div>
							<br/>
							<div class="edit-box">
								<div class="label" style="width:100px;"><label>图片</label></div>
								<button type="button" class="btn btn-default" id="singlepic1"> 选择APP图片 </button>
								<div class="input" id="singlepicdiv1"></div>
								<button type="button" class="btn btn-default" id="singlepic2"> 选择官网图片 </button>
								<div class="input" id="singlepicdiv2"></div>
							</div>
							<br/>
							<div class="edit-box">
