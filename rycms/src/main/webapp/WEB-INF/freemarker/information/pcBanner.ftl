...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" background="../../images/sctg/content_bg.gif"><table width="100%" height="58" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td height="31" colspan="2"><div class="title">pc焦点图维护 </div></td>
        </tr>
      </table></td>
  ...
  <tr> 
    ...
    <td valign="top" bgcolor="#F7F8F9"><table width="1380px;" border="0" align="center" cellpadding="0" cellspacing="0">
    	...
    	<form id="form1" name="form1" method="post" action="../../pic/save/">
	    	...
	    	<input type="hidden" id="code" name="code" value="index_pc" />	
		    	<ol class="ol">
		        	<li class="li">
		            	...
		            	<select name="sort" id="xb1" style="width:50px"><option selected="selected">1</option><option>2</option><option>3</option><option>4</option><option>5</option></select>
		            	...
		            	<input type="button" id="delete1" class="btn" style=" width:60px; line-height:15px;" value="删除" onclick="deleteImg(1);"/>
		            </li>
		            ...
		            <li class="li">
		            	请求：<input type="text" id="url2" name="url2" value="${appimageList[1].url}" class="my-url"/>
		      			...
		      			<select name="sort" id="xb2" style="width:50px"><option>1</option><option selected="selected">2</option><option>3</option><option>4</option><option>5</option></select>
		            	...
		            	<input type="button" id="delete2" class="btn" style=" width:60px; line-height:15px;" value="删除" onclick="deleteImg(2);"/>
		            </li>
		            ...
		            <li class="li">
		            	...
		            	<select name="sort" id="xb3" style="width:50px"><option>1</option><option>2</option><option selected="selected">3</option><option>4</option><option>5</option></select>
		            	...
		            	<input type="button" id="delete3" class="btn" style=" width:60px; line-height:15px;" value="删除" onclick="deleteImg(3);"/>
		            </li>
		            ...
		            <li class="li">
		            	...
		            	<select name="sort" id="xb4" style="width:50px"><option>1</option><option>2</option><option>3</option><option selected="selected">4</option><option>5</option></select>
		            	<input type="button" id="uploadClickInput4" value="上传" class="btn" style=" width:60px; line-height:15px;" onclick="uploadImg('img4','picpath4','fileId4');"/>		            		           
		           		<input type="button" id="delete4" class="btn" style=" width:60px; line-height:15px;" value="删除" onclick="deleteImg(4);"/>
		            </li>
		            ...
		            <li class="li">
		            	...
		            	<select name="sort" id="xb5" style="width:50px"><option>1</option><option>2</option><option>3</option><option >4</option><option selected="selected">5</option></select>
		            	<input type="button" id="uploadClickInput5" value="上传" class="btn" style=" width:60px; line-height:15px;" onclick="uploadImg('img5','picpath5','fileId5');"/>		            		           
		            	<input type="button" id="delete5" class="btn" style=" width:60px; line-height:15px;" value="删除" onclick="deleteImg(5);"/>
		            </li>
		            <#if (appimageList[4].id > 0)>
	          		    <img class="img" id="img5"  src="${appimageList[4].path}" alt="图片在此显示"  />
        ...
        <tr >
          ...
          <td width="51%" class="left_txt"><img src="../../images/sctg/icon_mail.gif" width="16" height="11"> 客户服务邮箱：ryfinance@ryfinance.com<br />
            <img src="../../images/sctg/icon_phone.gif" width="17" height="14"> 官方网站：<a href="http://www.ryfinance.com/" target="_blank">睿银金融服务有限公司</a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
