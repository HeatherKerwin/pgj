...
<div class="w1200 bc bae0e0e0 bcwhite mt20 mb20">
	<form id="form" method="post"  action="${basePath}/zhangbu/addpiaoju">
    <div class="pl20 pr20 f14 c2d2d2d">
        ...
        <div class="w h45">
            ...
            <input class="fl w100 bae0e0e0 h27 lh27 c2d2d2d mr10 mt8 ti8 inline" readonly="readonly" id="start" name="start"/>
            <label class="fl w30 h27 rili mt8" for="start"></label>
            <input type="hidden" name="begintime" />
        </div>
        <div class="w h45 xuxian">
            <div class="fl tl w100 fb lh45">到期日期：</div>
            <input class="fl w100 bae0e0e0 h27 lh27 c2d2d2d mr10 mt8 ti8 inline" readonly="readonly" id="end" name="end"/>
            <label class="fl w30 h27 rili mt8" for="end"></label>
            <input type="hidden" name="endtime" />
        </div>
        <div class="w h45 xuxian" id="lixi">
            <div class="fl tl w100 fb lh45">贴现利息：</div>
            <input id="tiexianlixi" name="tiexianlixi" type="text" placeholder="请输入金额" readonly="readonly" class="fl w129 h27 lh27 bae0e0e0 mt8 ti8">
            <div class="fl f14 lh45 ml10">元</div>
        </div>
        <div class="w h45 xuxian" id="jine">
            <div class="fl tl w100 fb lh45">贴现金额：</div>
            <input id="tiexianjine" name="tiexianjine" type="text" placeholder="请输入金额" readonly="readonly" class="fl w129 h27 lh27 bae0e0e0 mt8 ti8">
            <div class="fl f14 lh45 ml10">万元</div>
        </div>
        <div class="w mt10">
    ...
    <div class="w h70 bte0e0e0 bbe0e0e0 bcf9f9f9 tc pt15 f18 mt20 mb30">
        <a href="javascript:void(0);" id="save" class="fr cd43c33 bad43c33 br3 dsb w166 h45 lh45 mr40" onclick="save()">保存</a>
