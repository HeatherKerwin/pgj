...
<div class="w1200 bc">
    ...
    <div class="w clearfix mt20">
        ...
        <ul class="fl bcwhite f16 c2d2d2d lh50 tc TXtab oh mt6">
            ...
            <li class="w200 lh50 fl bbd43c33"><a href="${basePath}/zhangbu/account/book/in" class="cd43c33 dsb">待入账</a></li>
        </ul>
    ...
    <div class="w mt20 bcwhite box-shadow box-sizing pl20 pt20 pr20 pb20" id="endDates">
    	<div class="w tc">
	    	<div class="lh30 pt15 pb20 pl20 f14 clearfix">
				...
				<div class="fl"><input type="button" class="w150 h30 ba bad43c33 bcd43c33 mr20 cwhite br3 cp" value="查询" readonly="readonly" onclick="loadDateIn();"></div>
        ...
        <div class="w box-sizing bte0e0e0 ble0e0e0 bre0e0e0 tc mt20">
            <div class="h60 lh60 bcf9f9f9 f14 c717583 clearfix bbe0e0e0 box-sizing">
                <div class="fl w300 bre0e0e0 box-sizing">票面金额（元）</div>
                <div class="fl w331 bre0e0e0 box-sizing">来票公司</div>
                <div class="fl w230 bre0e0e0 box-sizing">入账提醒</div>
                <div class="fl w297">操作</div>
            </div>
            <ul id="dairuzhang"></ul>
        </div>
    </div>
            ...
            <div class="w lh30" style="display: none" id="editWindow">
            	<div>
                    ...
                    <div class="w mt10 clearfix pb10 xuxian">
                        ...
                        <input type="text" class="fl w100 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[required]" id="inDate" readonly="readonly">
                ...
                <!--按钮操作-->
                <div class="w mt20 clearfix tc buchong none">
                    <input type="button" value="票据入账" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="saveHold();">
                </div>
                <!--按钮操作-->
                <div class="w mt20 clearfix tc ruzhang">
                    <input type="button" value="票据入账" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" id="ruzhang">
...
<script type="text/x-handlebars-template" id="IN">
{{#each list}}
	<li class="pr bbe0e0e0 box-sizing">
		...
		<div class="clearfix f15 h86 lh86">
			<div class="fl w300 bre0e0e0 box-sizing">{{toAllmoney allmoney}}</div>
			<div class="fl w331 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
				<span class="lh24 text-line2">{{draftFrom}}</span>
			</div>
			<div class="fl w230 bre0e0e0 box-sizing">{{formatDate inData}}</div>
			<div class="fl w297">
				<a class="fl c3366cc cp w90 ml60" onclick="editList({{id}})">编辑</a>
				<a class="fl c3366cc w90 cp" onclick="deleteList({{id}});">删除</a>
			</div>
		</div>
	</li>
{{/each}}
 ...
 */
function loadDateIn(){
    var data = {memberId:memberId,recordType:"IN"};
...
function saveHold(){
	...
	if(!$("#inData").validationEngine("validate")){
		$("#inData").focus();
		return ;
	};
	...
	var params = {id:id,memberId:memberId,draftType:draftType,bank:bank,draftNo:draftNo,allmoney:(parseFloat(allmoney)*10000),
			inDate:inDate,expiryDate:expiryDate,draftFrom:draftFrom,draftTo:draftTo};
	...
	if(data != null){
		if(data.data.response == 'success'){
		    ...
		    $(".ruzhang").removeClass("none");
			$(".buchong").addClass("none");
		    loadDateIn();
		}else{
			alert(data.data.msg);
		}
...
function save(){
	...
	var params = {id:id,memberId:memberId,allmoney:(parseFloat(allmoney)*10000),inDate:inDate,draftFrom:draftFrom};
	var url = '${bootAppPath}/draftrecord/save';
...
$("#ruzhang").click(function(){
	$(".ruzhang").addClass("none");
	$(".buchong").removeClass("none");
});
