...
<div class="w1200 bc">
    ...
    <div class="w clearfix mt20">
        ...
        <ul class="fl bcwhite f16 c2d2d2d lh50 tc TXtab oh mt6">
            ...
            <li class="w200 lh50 fl bre0e0e0 bbd43c33 "><a href="${basePath}/zhangbu/account/book/hold" class="cd43c33 dsb">持有中</a></li>
    ...
    <div class="w mt20 bcwhite box-shadow box-sizing pl20 pt20 pr20 pb20" id="endDates">
    	<div class="w clearfix">
	    	<div class="lh30 pt15 pb20 pl20 f14 clearfix">
				...
				<div class="fl"><input type="button" class="w150 h30 ba bad43c33 bcd43c33 mr20 cwhite br3 cp" value="查询" readonly="readonly" onclick="loadDateHold();"></div>
        ...
        <div class="w box-sizing bte0e0e0 ble0e0e0 bre0e0e0 tc mt20">
            <div class="h60 lh60 bcf9f9f9 f14 c717583 clearfix bbe0e0e0 box-sizing">
                ...
                <div class="fl w260 bre0e0e0 box-sizing">来票公司</div>
                <div class="fl w130 bre0e0e0 box-sizing">票据提醒</div>
    ...
    <div class="bc w590 bcwhite bae0e0e0 br3 box-sizing pb20 mt170">
        ...
        <div class="w box-sizing pl20 pr20 oya" style="max-height: 500px;">
            ...
            <div class="w lh30" style="display: none" id="editWindow">
                ...
                <div class="w mt10 clearfix pb10 xuxian">
                    <div class="fr clearfix nopledge">
                        <div class="fl w100 fb">提醒日期：</div>
                        <input type="text" class="fl w100 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[required]" id="noticeDate" readonly="readonly">
                        <div class="fl w30 h27 rili ml10 mt1 cp"></div>
                    </div>
                    <div class="fr clearfix pledge none">
                ...
                <div class="w mt10 clearfix pb10 xuxian pledge none">
                    <div class="clearfix">
                ...
                <div class="w mt10 clearfix pb10 xuxian nopledge">
                    <div class="fl w100 fb">实收票款：</div>
                    <input type="text" id="txje" oninput="zongkouxi();" class="fl w120 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10">
                ...
                <!--按钮操作-->
                <div class="w mt20 clearfix tc nopledge">
                    <input type="button" value="保存" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="save(1);">
                    <input type="button" value="出库" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="save(2);">
                    <input type="button" value="质押" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="pledge();">
                </div>
                
                <div class="w mt20 clearfix tc pledge none">
                    <input type="button" value="保存为质押" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="save(3);">
                </div>
                <div id="content">
...
{{#each list}}
	<li class="pr bbe0e0e0 box-sizing">
		...
		<div class="clearfix f15 h86 lh86">
			...
			<div class="fl w260 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
				<span class="lh24 text-line2">{{draftFrom}}</span>
			</div>
			<div class="fl w130 bre0e0e0 box-sizing">{{formatDate noticeDate}}</div>
			<div class="fl w208">
				<a class="fl c3366cc cp w50 ml10" onclick="editList({{id}})">编辑</a>
				<a class="fl c3366cc w50 cp" onclick="deleteList({{id}});">删除</a>
				<a class="fl ce84c3d bae84c3d w50 br3 lh24 cp mt30 ml15" href="javascript:checkAccount(0,'/discountrecord/discount_yp1');">去下单</a>
			</div>
		</div>
	</li>
{{/each}}
 ...
 */
function pledge(){
	$(".nopledge").addClass("none");
	$(".pledge").removeClass("none");
}

/**
 *  加载票据提醒（已持有）
 */
function loadDateHold(){
...
function editList(id){
	$(".nopledge").removeClass("none");
	$(".pledge").addClass("none");
	$("#content").html("");
	$("#billId").val(id);
	var params = {id:id};
...
function save(num){
	...
	var pledgeInDate = $("#pledge_in_date").val();
	var pledgeOutDate = $("#pledge_out_date").val();
	...
	if(num==3){
		...
		if(!$("#noticeDate").validationEngine("validate")){
			$("#noticeDate").focus();
			return ;
		};
	}
	...
	var params = {id:id,memberId:memberId,draftType:draftType,bank:bank,draftNo:draftNo,allmoney:(parseFloat(allmoney)*10000),
			noticeDate:noticeDate,expiryDate:expiryDate,draftFrom:draftFrom,draftTo:draftTo,json:json};
	if(num == 2){
