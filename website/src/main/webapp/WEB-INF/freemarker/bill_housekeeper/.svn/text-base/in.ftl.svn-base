...
<div class="w1200 bc">
    ...
    <div class="w mt20 bcwhite box-shadow box-sizing pl20 pt20 pr20 pb20" id="endDates">
        <div class="f16 lh20">
            <div class="bl3_d43c33 pl14">待入账提醒</div>
            <p class="f16 c636262 mt10">以下票据即将入账：</p>
        </div>
        ...
        <div class="w box-sizing bte0e0e0 ble0e0e0 bre0e0e0 tc mt20">
            <div class="h60 lh60 bcf9f9f9 f14 c717583 clearfix bbe0e0e0 box-sizing">
                ...
                <div class="fl w598 bre0e0e0 box-sizing">来票公司</div>
                <div class="fl w260">票据提醒</div>
            </div>
            <ul id="dairuzhang"></ul>
        </div>
    </div>
...
{{#each list}}
	<li class="pr bbe0e0e0 box-sizing">
		...
		<div class="clearfix f15 h86 lh86">
			...
			<div class="fl w598 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
				<span class="lh24 text-line2">{{draftFrom}}</span>
			</div>
			<div class="fl w260">{{formatDate inData}}</div>
		</div>
	</li>
{{/each}}
</script>
