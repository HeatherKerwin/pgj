...
<div class="w1200 bc">
    ...
    <div class="w clearfix mt20">
        ...
        <ul class="fl bcwhite f16 c2d2d2d lh50 tc TXtab oh mt6">
            <li class="w200 lh50 fl bre0e0e0 bbd43c33"><a href="${basePath}/zhangbu/account/book/out" class="cd43c33 dsb">已出库</a></li>
            <li class="w200 lh50 fl bre0e0e0"><a href="${basePath}/zhangbu/account/book/hold" class="c2d2d2d dsb">持有中</a></li>
            <li class="w200 lh50 fl bre0e0e0"><a href="${basePath}/zhangbu/account/book/pledge" class="c2d2d2d dsb">质押中</a></li>
    ...
    <div class="w mt20 bcwhite box-shadow box-sizing pl10 pt20 pr10 pb20" id="endDates">
    	<div class="w tc">
	    	<div class="lh30 pt15 pb20 pl20 f14 clearfix">
				...
				<div class="fl"><input type="button" class="w150 h30 ba bad43c33 bcd43c33 mr20 cwhite br3 cp" value="查询" readonly="readonly" onclick="loadDateOut();"></div>
            ...
            <div class="w lh30" style="display: none" id="editWindow">
                ...
                <div class="w h30 mt20 clearfix pb10 xuxian">
                    ...
                    <ul class="fl ryRadioCheckd mt3 ml20">
                        <li>
                            <input class="ryRadio noedit" type="radio" id="type0" name="type" value="0" checked>
                            <label class="checked" for="type0">银电</label>
                        </li>
                        <li>
                            <input class="ryRadio noedit" type="radio" id="type1" name="type" value="1">
                            <label for="type1">银纸</label>
                        </li>
                        <li>
                            <input class="ryRadio noedit" type="radio" id="type2" name="type" value="2">
                            <label for="type2">商电</label>
                        </li>
                        <li>
                            <input class="ryRadio noedit" type="radio" id="type3" name="type" value="3">
                ...
                <div class="w mt10 clearfix pb10 xuxian">
                    ...
                    <input type="text" id="bank" class="noedit fl w200 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[required]" placeholder="请输入承兑行全称">
                </div>

                <div class="w mt10 clearfix pb10 xuxian">
                    <div class="fl w100 fb">票号：</div>
                    <input type="text" id="draftNo" class="noedit fl w200 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[custom[draftNo]]" placeholder="请输入票号（选填）">
                </div>

                <div class="w mt10 clearfix pb10 xuxian">
                    <div class="fl w100 fb">票面金额：</div>
                    <input type="number" id="allmoney" class="noedit fl w200 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[custom[Okmoney]],validate[required],validate[custom[number]],validate[custom[money]]" placeholder="请输入票面金额">
                </div>

                <div class="w mt10 clearfix pb10 xuxian">
                    <div class="fl clearfix">
                        <div class="fl w100 fb">贴现日期：</div>
                        <input type="text" class="noedit fl w100 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10" id="startDate" readonly="readonly">
                        <div class="fl w30 h27 rili ml10 mt1 cp"></div>
                    </div>

                    <div class="fr clearfix">
                        <div class="fl w100 fb">到期日期：</div>
                        <input type="text" class="noedit fl w100 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[required]" id="endDate" readonly="readonly">
                        <div class="fl w30 h27 rili ml10 mt1 cp"></div>
                    </div>
                ...
                <div class="w mt10 clearfix pb10 xuxian">
                    ...
                    <input type="text" id="txje" oninput="zongkouxi();" class="noedit fl w120 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10 validate[required]">
                    <div class="fl ml20 cp f14">总扣息：<span id="zongkouxi"></span></div>
                </div>
                ...
                <div class="w mt20 clearfix tc">
                    <input type="button" value="保存" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 cp" onclick="save();">
                </div>
                <div id="content">
...
<script type="text/x-handlebars-template" id="OUT">
{{#each list}}
	<li class="clearfix box-sizing">
		<div class="fl w18 tc h40 mt20 lh20 box-sizing {{toRecordWayColor recordWay}}">{{toRecordWay recordWay}}</div>
		<div class="fl pr ble0e0e0 bbe0e0e0">
			...
			<div class="clearfix f15 h86 lh86">
				<div class="fl w200 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
					<span class="lh24 text-line2">{{bank}}</span> 
				</div>
				<div class="fl w130 bre0e0e0 box-sizing">{{toAllmoney allmoney}}</div>
				<div class="fl w140 bre0e0e0 box-sizing">{{txje}}</div>
				<div class="fl w140 bre0e0e0 box-sizing">{{formatDate expiryDate}}</div>
				<div class="fl w180 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
					<span class="lh24 text-line2">{{draftFrom}}</span>
				</div>
				<div class="fl w180 bre0e0e0 box-sizing pl35 pr10 pt20 pb15 h">
					<span class="lh24 text-line2">{{draftTo}}</span>
				</div>
				<div class="fl tc w190">
					<div class="clearfix">
						<a class="fl c3366cc cp w50 ml30" onclick="editList({{id}})">编辑</a>
						<a class="c3366cc w50 cp" onclick="deleteList({{id}});">删除</a>
					</div>
				</div>
			</div>
		</div>
...
* 票据来源（系统，手动）
*/
Handlebars.registerHelper('toRecordWay', function(recordWay, options) {
	if(recordWay == "MEMBER"){
		return "手动";
	}else {
		return "系统";
...
* 票据来源（系统，手动）
*/
Handlebars.registerHelper('toRecordWayColor', function(recordWay, options) {
	if(recordWay == "MEMBER"){
		return "c33c879 ba33c879";
	}else {
		return "";
	}
});
 ...
 *  加载票据提醒（待入账）
 */
function loadDateOut(){
    var data = {memberId:memberId,recordType:"OUT"};
			...
			if(data.json!=null&&data.json!=""){
				...
				$.each(obj, function (n, value) {
	 				if(value.key!=""&&value.key!=null){
	 					...
	 					html += '<div class="w mt10 clearfix pb10 xuxian"><div class="fl w100 fb">';
	 					html += n+'：</div><input type="text" data-name="'+n+'" oninput="change(this);" value="'+value.value+'" class="fl w360 h30 box-sizing bae0e0e0 br3 ml20 pl10 pr10"></div>';
	 				}
	            });
				$("#content").append(html);
			}
			
			if(data.recordWay == "SYSTEM"){
			...
			$("#startDate").val(data.tiexianDate);
			$("#endDate").val(data.expiryDate);
			$("#zongkouxi").html((parseFloat(data.allmoney)-parseFloat(data.txje)).toFixed(2));
...
function save(){
	...
	if(!$("#txje").validationEngine("validate")){
		$("#txje").focus();
		return ;
	};
	...
	var params = {id:id,memberId:memberId,draftType:draftType,bank:bank,draftNo:draftNo,allmoney:(parseFloat(allmoney)*10000),txje:txje,
			tiexianDate:tiexianDate,expiryDate:expiryDate,draftFrom:draftFrom,draftTo:draftTo,json:json};
...
function zongkouxi(){
	...
	if(txje != null && allmoney != null && txje != "" && allmoney != ""){
		$("#zongkouxi").html(parseFloat(allmoney*10000)-parseFloat(txje));
	}
};
...
var search_end_Date = {
    ...
    istoday : false,
    choose : function(datas) {
    	search_start_Date.max = datas; //结束日选好后，重置开始日的最大日期
    }
};
