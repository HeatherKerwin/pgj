...
<div class="w ha cp toggle" >
    <a href="${basePath}/piaojuxueyuan/detail/{{id}}?type=2" class="mt12 lh24 pt20 pb10 pl10 pr10 c2d2d2d">{{titleShow}}</a>
    <div class="cb"></div>
</div>
</div>
{{/each}}
