...
<script type="text/javascript" src="${pluPath}/data/laydate.js"></script>
	...
	<div class="backstage">
	    ...
	    <div class="backstageForm">
    		...
    		<!-- list -->
    		<!-- 大票审核 dpshList -->
			<div class="backtageList dpshList">
	...
	<div class="maskWindow" style="display: none;">
		...
		<div class="maskWrap maskWrapSmall">
			...
			<div class="maskCon">
				<div class="maskDiv">
					<!-- 大票换小票审核 -->
					<div class="backstageMask" id="dapiaoMask" style="display: none;">
						<!-- 企业信息 -->
						<div class="qiyeForm">
							<div class="qiyeRow">
								<div class="qiyeRow-child">
									...
									<div class="qiyeFormInp">
										<input type="text" id="company" value="--" class="inp-warning" readonly>
									</div>
								</div>
								<div class="qiyeRow-child">
									<label>企业状态</label>
									<div class="qiyeFormInp">
										<input type="text" id="check_state" value="--" class="inp-warning" readonly>
									</div>
								</div>
							</div>
							<div class="qiyeRow clearfix">
								<div class="qiyeRow-child">
									<label>联系人</label>
									<div class="qiyeFormInp">
										<input type="text" id="contactName" value="--" class="inp-warning" readonly>
									</div>
								</div>
								<div class="qiyeRow-child">
									<label>联系方式</label>
									<div class="qiyeFormInp">
										<input type="text" id="contactMobile" value="--" class="inp-warning" readonly>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="piaoForm">
							...
							<div class="piaoCon">
								<div class="piaoConRow clearfix">
									<div id="money">--</div>
									<div id="bank">--</div>
									<div id="exchangeDate">--</div>
									<div id="endDate">--</div>
									<div id="days">--</div>
									<div><a href="javascript:void(0);" id="draftUrl" target="_blank">查看</a></div>
								</div>
							</div>
						</div>
						<!-- 票面信息 end -->
...
{{#each list}}
	<div class="list-row clearfix">
		...
		<div>{{toEndDate detail}}</div>
		<div>{{toDays detail}}</div>
...
Handlebars.registerHelper('toCheckState', function(state, options) {
	...
	*/
	function loadDate(){
    	layer.load(2);
		var data = {operateId:memberId,type:"B2S"};
			...
			success:function(data){
				...
				if(data.data.response == 'success'){
					...
					if(detail!=null&&detail.length>0){
						$("#money").html(detail[0].money);
						$("#bank").html(detail[0].bank);
						$("#endDate").html(detail[0].endDate);
						$("#draftUrl").attr("href","${imagePath}"+detail[0].draftUrl);
						var days = surplusDay(detail[0].endDate);
						$("#days").html(days);
					}
				}else{
