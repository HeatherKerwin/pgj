...
public interface AdminDao {
	...
	Admin getAdmin(Integer id,String username, String password);	
	
	public Admin getAdminById1(Integer id);	
	
	List<Admin> getList(Integer id,String username);
	...
	List<Admin> getList1(Integer id, String username);
