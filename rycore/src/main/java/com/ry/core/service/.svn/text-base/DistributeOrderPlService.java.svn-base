...
public interface DistributeOrderPlService {
	
	/**
	 * 根据主键获取对象
	 * @author KHC
	 * @param id
	 * @since 2016年7月28日 下午4:23:58
	 */
	...
	/**
	 * 根据主键获取订单详情（含完整贴现订单详情）
	 * @author WKX
	 * @param id
	 * @since 2016年9月8日 下午2:16:05
	 */
	...
	/**
	 * 接受订单（机构企业都变成正在交易中，并做简单验证）
	 * @author WKX
	 * @param distributeOrderPl
	 * @throws Exception
	 * @since 2016年9月11日 下午1:25:13
	 */
