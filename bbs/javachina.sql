...
ALTER TABLE t_userinfo ADD name VARCHAR(50) DEFAULT NULL COMMENT '用户名';
ALTER TABLE t_userinfo ADD company VARCHAR(50) DEFAULT NULL COMMENT '企业名称';
ALTER TABLE t_userinfo ADD phone VARCHAR(50) DEFAULT NULL COMMENT '联系方式';
ALTER TABLE t_userinfo ADD wechat VARCHAR(50) DEFAULT NULL COMMENT '微信';
ALTER TABLE t_userinfo ADD qq VARCHAR(50) DEFAULT NULL COMMENT 'qq';

alter table t_user add member_id int(11) DEFAULT NULL COMMENT 'APP用户主键';
...
CREATE TABLE `t_pointlog` (
  ...
  `hid` INT(10) COMMENT '用户主键（触发者）',
  `score` INT(10) COMMENT '分数',
  `fun` VARCHAR(64) COMMENT '事件',
  `fk_id` INT(10) COMMENT '外键（帖子主键）',
  `create_time` INT(10) NOT NULL COMMENT '签到时间',
  KEY `id` (`id`)
) ENGINE=MYISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_ticket` (
  ...
  `source` INT(10) DEFAULT NULL COMMENT '来源（0注册、1邀请用户）',
  `create_time` DATETIME DEFAULT NULL COMMENT '创建时间',
