...
<div class="flex flex-direction-column mt25 w1150 bc bcwhite pt30 pl25 pr25 pb25 mb20">
    ...
    <div class="flex-row flex-justify-space-between bbe0e0e0 h27 lh18 mt30">
        <div class="flex-row flex-direction-row">
            <span class="cd43c33 f18 fb">商票报价</span>
            <div class="ml30"><img src="https://img.utiexian.com/website/receive/position.png" class="h16 mr3 mt3"><span class="place"></span></div>
        </div>
        <div class="flex-row flex-direction-row">
    	...
    	<div class="ordershang pr">
	        ...
	        <div class="flex-row flex-justify-space-between bbe0e0e0">
	            ...
	            <div class="flex-row flex-direction-row flex-wrap w320 lh34 tc">
	                <div class="c00a5f2 w96 h35 br10 ba00a5f2 ml35 mt16 none accept_time_dian"></div>
	                <div class="c00a5f2 w96 h35 br10 ba00a5f2 ml35 mt16 type1"></div>
	                <div class="c00a5f2 w96 h35 br10 ba00a5f2 ml35 mt16 none need_todoor">需要上门</div>
	            </div>
	        </div>
        </div>
        <!-- 企业信息 -->
    ...
    <div class="flex-row flex-direction-column w bte0e0e0 ble0e0e0 bre0e0e0 mt10">
        ...
        <div class="flex-row flex-direction-column w lh50">
            <div class="flex-row flex-direction-row w tc bcf9f9f9 bbe0e0e0 c717583">
                ...
                <div class="flex-col-6">打款金额<span class="cd43c33">(电票包含兴业数金鉴证服务费)</span></div>
            </div>
            ...
            <div class="pl20 pr20">
                ...
                <div class="flex-row flex-direction-column flex-alignItems-center w hmin150 none" id="endorseWindow">
                    ...
                    <div class="flex-row flex-justify-center lh30 mt20">
                        <input type="button" value="确认" class="w120 h35 ba bad43c33 bcd43c33 cwhite br3 mr20">
                    </div>
                </div>
...
<script type="text/javascript">
	...
	*/
    function loadDate(){
    	var url = '${bootAppPath}/distributeordersp/get/details';
		var params = {id:id};
	...
	*/
	function agreeContract(){
		...
		setTimeout(function(){
			var url = '${bootAppPath}/distributeordersp/update/advancetime';
	...
	*/
	$("#endorseBtn").click(function(){
		...
		var url = '${bootAppPath}/distributeordersp/update/confirmendorsetime';
	...
	*/
	$("#comment").click(function(){
		...
		var params = {service:service,speed:speed,price:price,dcrdId:dcrdId,dtboId:dtboId,role:1,type:1,operatorId:memberId,content:content};
		var data = bootPost(url,params);
		console.log(data);
		if(data != null){
			if(data.data.response == 'success'){
				...
				alert("评论成功");
				location.href = "${basePath}/distributeordersp/list";
			}else{
				alert(data.data.msg);
			}
		}
	...
	*/
	$(".download").click(function(){
		...
		if(dist_bind_id!=null){
			...
			var params = {orderId:distId,orderType:"DISTRIBUTEORDERSP"};
			var data = bootPost(url,params);
			console.log(data);
			if(data != null){
				if(data.data.response == 'success'){
	...
	*/
	$("#updatePrice").click(function(){
    	...
    	var order_type = 'DISCOUNTRECORDSP';
