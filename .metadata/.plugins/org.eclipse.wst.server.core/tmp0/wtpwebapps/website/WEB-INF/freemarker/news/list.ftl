...
<ul class="pl20 pr20 SCXXlist">
	<li class="w mt40 pb40 xuxian">
	    <div class="fl">
	        <a href="${basePath}/news/detail/{{id}}" target="_blank"><img src="${imagePath}{{pic1}}" class="w190 h120"></a>
	    </div>
	    <div class="fl ml40 w910">
	        <a href="${basePath}/news/detail/{{id}}" class="c2d2d2d" target="_blank"><div class="f18">{{title}}</div></a>
	        <div class="f14 mt10">
